...
<div class='formMiddleContent formMiddleContent303 moduleContent'><div class='cubeNavigationArea cubeNavigationArea5' id='cubeNavigation303'>
    <form action="" method="get" style="border-color: #006600; border-style: dotted; border-width: 2px"> 
        <label style="padding-left:50px;color:orange;"><b style="font-size:15px;">请选择查询销售统计的方式：</b><br/><br/> </label>
            <label style="padding-left:50px; "><a href="sales_statistics_query_bycode.html"><button class="btn btn-large btn-primary" type="button">按商品条码查找</button></a> </label> 
            <br/><br/>       			
    </form>

    <div class="table-responsive" style="padding-top:20px; ">
   <table class="table">
      <caption><b  style="font-size:18px;">销售汇总列表</b></caption>
      <thead>
         <tr>
            <th>商品条码</th>
            <th>商品名称</th>
      ...
      <tbody>
		...
		$sql = "SELECT bar_code,main_pro_name, SUM(num) as all_num,SUM(price) as all_money FROM inventory_out group by bar_code";
