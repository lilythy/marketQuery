...
<div class='formMiddleContent formMiddleContent303 moduleContent'><div class='cubeNavigationArea cubeNavigationArea5' id='cubeNavigation303'>
    <form method="post" role="form" action="inventory_query_byname.php" style="border-color: #006600; border-style: dotted; border-width: 2px"> 
        <label style="padding-left:50px;color:orange;"><b style="font-size:15px;">请输入商品名称：</b><br/><br/> </label>
            <label style="padding-left:50px; "><input class="span3"name="proname" id="proname" type="text"/> </label> 
            <label style="padding-left:20px; "><input class="btn btn-large btn-danger" type="submit" id="submit" onclick="window.location.href='inventory_query_byname.php'"></input> </label><br/><br/>       			
    </form>

    <div class="table-responsive" style="padding-top:20px; ">
   <table class="table">
      <caption><b  style="font-size:18px;">库存商品列表</b></caption>
      <thead>
         <tr>
            <th>商品名称</th>
            <th>进价</th>
      ...
      <tbody>
		...
		$sql = "SELECT productName,purch_price,final_price,in_num,total_price FROM inventory";
