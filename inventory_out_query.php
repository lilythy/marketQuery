...
<div class='formMiddleContent formMiddleContent303 moduleContent'><div class='cubeNavigationArea cubeNavigationArea5' id='cubeNavigation303'>
    <form action="" method="get" style="border-color: #006600; border-style: dotted; border-width: 2px"> 
        <label style="padding-left:50px;color:orange;"><b style="font-size:15px;">请选择查询入库单的方式：</b><br/><br/> </label>
            <label style="padding-left:50px; "><a href="inventory_out_query_bycode.html"><button class="btn btn-large btn-primary" type="button">按出库单号查找</button></a> </label> 
            <label style="padding-left:20px; "><a href="inventory_out_query_bytime.html"><button class="btn btn-large btn-danger" type="button">按出库时间查找</button> </label><br/><br/>       			
    </form>

    <div class="table-responsive" style="padding-top:20px; ">
   <table class="table">
      <caption><b  style="font-size:18px;">出库记录列表</b></caption>
      <thead>
         <tr>
            <th>出库单号</th>
            <th>商品名称</th>
      ...
      <tbody>
		...
		$sql = "SELECT out_code,main_pro_name,final_price,num,price,bossID FROM inventory_out";
