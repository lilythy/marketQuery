...
<div class='formMiddleContent formMiddleContent303 moduleContent'><div class='cubeNavigationArea cubeNavigationArea5' id='cubeNavigation303'>
    <div action="" method="" style="border-color: #006600; border-style: dotted; border-width: 2px"> 
        <label style="padding-left:50px;color:orange;"><b style="font-size:15px;">若想查看某一天的经营状况请点击下面按钮：</b><br/><br/> </label> 
            <label style="padding-left:20px; "><a href="op_conditions_query_bytime.html"><button class="btn btn-large btn-danger" type="button">按入库时间查找</button> </label><br/><br/>       			
    </div>

    <div class="table-responsive" style="padding-top:20px; ">
   <table class="table">
      <caption><b  style="font-size:18px;">经营状况</b></caption>
      <thead>
         <tr>
            <th>商品条码</th>
            <th>商品名称</th>
