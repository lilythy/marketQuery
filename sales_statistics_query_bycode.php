...
$sql="SELECT bar_code,main_pro_name, SUM(num) as all_num,SUM(price) as all_money FROM inventory_out WHERE bar_code = '".$barcode."'";
...
<div class='formMiddleContent formMiddleContent303 moduleContent'><div class='cubeNavigationArea cubeNavigationArea5' id='cubeNavigation303'>
   ...
   <table class="table">
      <caption><b  style="font-size:18px;">销售汇总</b></caption>
      <thead>
         <tr>
            <th>商品条码</th>
            <th>商品名称</th>
      ...
      <tbody>  
		...
		<td><?php echo $row['all_num'];?></td>
		<td><?php echo $row['all_money'];?></td>
		</tr>
