...
<div class='formMiddleContent formMiddleContent303 moduleContent'><div class='cubeNavigationArea cubeNavigationArea5' id='cubeNavigation303'>
    <form action="" method="get" style="border-color: #006600; border-style: dotted; border-width: 2px"> 
        <label style="padding-left:50px;color:orange;"><b style="font-size:15px;">请选择搜索商品的方式：</b><br/><br/> </label>
            <label style="padding-left:50px; "><a href="pr_query_bycode.html"><button class="btn btn-large btn-primary" type="button">按商品条码查找</button></a> </label> 
            <label style="padding-left:20px; "><a href="pr_query_byname.html"><button class="btn btn-large btn-danger" type="button">按商品名称查找</button> </label><br/><br/>       			
    </form> 
