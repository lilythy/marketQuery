...
<div class='formMiddleContent formMiddleContent303 moduleContent'><div class='cubeNavigationArea cubeNavigationArea5' id='cubeNavigation303'>
	...
	<div style="padding-top:10px"><div class="item1" >商品码</div><div class="item2"><input id="barcode" name="barcode" type="text"readonly value="<?php echo $barcode ?>"/></div></div>
	<div style="padding-top:10px"><div class="item1" >商品名称：</div><div class="item2"><input id="product_name" name="product_name" type="text"readonly value="<?php echo $row['productName']?>" /></div></div>
		<div style="padding-top:10px"><div class="item1" >售价：</div><div class="item2"><input id="final_price" name="final_price" type="text"readonly value="<?php echo $row['final_price']?>"/></div></div>
		...
		<div style="padding-top:10px"><div class="item1" >仓库：</div><div class="item2"><input id="store_house" name="store_house" type="text"readonly value="<?php echo $row['houseName']?>"/></div></div>
		<div style="padding-top:10px"><div class="item1" >单位：</div><div class="item2"><input id="measur_units" name="measur_units" type="text"readonly value="<?php echo $row['measur_units']?>"/></div></div>
		<div style="padding-top:10px"><div class="item1" >备注：</div><div class="item2"><input id="remark" name="remark" type="text" value="<?php echo $row['remark']?>"/></div></div>
	<div style="padding-top:15px;padding-left:80px;margin-bottom:30px;"><input type="submit" id="submit" name="submit" style="width:285px;height:40px;boder-radius:20px;float: left;margin-right:10px" value="确定"></div>
    </form>
	</div>
</div></div>
