...
<div class='formMiddleContent formMiddleContent303 moduleContent'><div class='cubeNavigationArea cubeNavigationArea5' id='cubeNavigation303'>
    <form method="post" role="form" action="" style="border-color: #006600; border-style: dotted; border-width: 2px"> 
        <label style="padding-left:50px;color:orange;"><b style="font-size:15px;">请选择查询入库单的方式：</b><br/><br/> </label>
            <label style="padding-left:50px; "><a href="inventory_in_query_bycode.html"><button class="btn btn-large btn-primary" type="button">按入库单号查找</button></a> </label> 
            <label style="padding-left:20px; "><a href="inventory_in_query_bytime.html"><button class="btn btn-large btn-danger" type="button">按入库时间查找</button> </label><br/><br/>       			
    </form>
	

    <div class="table-responsive" style="padding-top:20px; ">
   <table class="table">
      <caption><b  style="font-size:18px;">入库记录列表</b></caption>
      <thead>
         <tr>
            <th>入库单号</th>
            <th>商品名称</th>
      ...
      <tbody>
		...
		$sql = "SELECT in_code,main_pro_name,purch_price,num,price,store_house,operatorMan FROM inventory_in";
		...
		<td><?php echo $row['main_pro_name'];?></td>
		<td><?php echo $row['purch_price'];?></td>
		<td><?php echo $row['num'];?></td>
		<td><?php echo $row['price'];?></td>
		<td><?php echo $row['store_house'];?></td>
		<td><?php echo $row['operatorMan'];?></td>
		</tr>
        <?php
		}	  
	  ?>
